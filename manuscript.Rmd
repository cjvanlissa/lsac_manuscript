...
For both, the most important moderator was father involvement (e.g., "In the past month how often did you eat an evening meal with this child"), which stood out above all other moderators for paternal warmth.
...
Child-reported family climate was also important for both maternal and paternal warmth ("How often do people in your family yell at each other?").
Finally, two adolescent characteristics ranked high for both:
children's enjoyment of (physical) activity, which might be an indicator of children's good health,
and school concerns (i.e., the child behaved poorly).
